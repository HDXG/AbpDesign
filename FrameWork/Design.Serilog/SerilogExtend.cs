    ...
    public static class SerilogExtend
    {
        public static void AddSerilog(this ConfigureHostBuilder configureHostBuilder)
        {
            ...
            Log.Logger = new LoggerConfiguration()
                ...
                .WriteTo.MSSqlServer("Server=.;Database=NewAbp;User ID=sa;Password=sa;TrustServerCertificate=true", sinkOptions: GetSqlServerSinkOptions(), columnOptions: GetColumnOptions())
            ...
            ColumnOptions GetColumnOptions()
            {
                ...
                var columList = new List<SqlColumn>
                {
                    ...
                    new SqlColumn("ResponseJson", SqlDbType.NVarChar, true, 1000),//添加一列，用于记录响应数据
                    new SqlColumn("ExceptionMessage", SqlDbType.NVarChar, true, 2000),//添加一列，用于记录响应数据
